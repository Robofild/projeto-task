...
export default props=>{
    ...
    const getRightContent=()=>{
        ...
        return(
            ...
            <TouchableOpacity style={styles.right}  >
                <Icon onPress={()=>props.onShowMoveReceived && props.onShowMoveReceived(props.id,props.desc,props.estimateAt,props.value)} style={styles.icon} name="clone" size={40} color='#fff'/> 
    ...
    return(
        ...
        <View style={styles.container}>
            ...
            <TouchableWithoutFeedback onPress={()=>props.onToggleReceived(props.id)}>
